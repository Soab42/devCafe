      ...
      <div className="card">
        <div class="s-post-summary--content">
          ...
          <div class="s-post-summary--content-excerpt">
            I have an example of curl request: curl -X "POST"
            "http://192.168.24.62:8080/upload" \ -H 'Content-Type:
            multipart/form-data; charset=utf-8' \ -F "file=@test.wav&amp;...
          </div>
              ...
              <ul class="ml0 list-ls-none js-post-tag-list-wrapper d-inline">
                <li class="d-inline mr4 js-post-tag-list-item">
                  <a
                    ...
                    rel="tag"
                    aria-labelledby="tag-python-tooltip-container"
                  >
                    python
                  </a>
                </li>
                <li class="d-inline mr4 js-post-tag-list-item">
                  <a
                    ...
                    class="post-tag flex--item mt0 js-tagname-curl"
                    title="show questions tagged 'curl'"
                    aria-label="show questions tagged 'curl'"
                    rel="tag"
                    aria-labelledby="tag-curl-tooltip-container"
                  >
                    curl
                  </a>
                </li>
                <li class="d-inline mr4 js-post-tag-list-item">
                  <a
                    ...
                    class="post-tag flex--item mt0 js-tagname-python-requests"
                    title=""
                    aria-label="show questions tagged 'python-requests'"
                    rel="tag"
                    aria-labelledby="tag-python-requests-tooltip-container"
                  >
                    python-requests
                  </a>
                </li>
            ...
            <div class="s-user-card s-user-card__minimal" aria-live="polite">
              ...
              <div class="s-user-card--info">
                <div class="s-user-card--link d-flex gs4">
                  <a href="/users/16298153/gawain" class="flex--item">
                    Gawain
                  </a>
                </div>
              ...
              <time class="s-user-card--time">
                asked{" "}
                <span title="2023-11-10 12:41:40Z" class="relativetime">
                  2 hours ago
                </span>
              </time>
            </div>
