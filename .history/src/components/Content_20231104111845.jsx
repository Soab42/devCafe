...
export default function Content() {
  const text = `This is some text. #code <html>This is the content to be captured.</html> #endcode More text here. #code <html>Another code block.</html> #endcode Final text.#code code function greet(name){console.log("Hello, " + name);}#endcode`;
  ...
  return (
    <div>
      {chunks.map((chunk, index) => {
        const modifiedText = chunk.replace(/\s+</g, "<");
