...
export default function Content() {
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <button className="btn hover:bg-blue-400/20 shadow-md hover:shadow-lg duration-300 text-slate-400 absolute shadow-blue-400/20 hover:text-black font-bold ring-1 w-24 h-8">
        Ask Question
      </button>
      {/* tags */}
