    ...
    <div>
      ...
      <main className="flex-center flex-col w-full ">
        <div className="md:w-[60%] w-[90%] bg-slate-300/20 flex justify-start px-2">
          ...
          <content className="flex justify-between w-full  h-[95vh] overflow-y-scroll">
            <section className="p-2 w-full h-screen bg-red-200/20 border-r-[1px] border-slate-500">
              {children}
            </section>
