    ...
    show && (
      <div className="absolute h-[10rem] md:w-[20rem] w-[14rem] right-0 top-8 flex items-center p-4 bg-slate-50/10 backdrop-blur-sm z-50 font-sans text-xs flex-col">
        ...
        <div className="flex flex-col gap-2 mt-6">
          <div className="flex-center gap-1 text-slate-700 bg-sky-900 p-2 rounded-full cursor-pointer hover z-0">
            <span className="text-xl text-green-600">
              <AiFillGoogleCircle />
            </span>
            Sign In With Google
          </div>
          <div className="flex-center gap-1 p-2 rounded-full cursor-pointer  text-slate-400 hover z-0 bg-sky-900">
