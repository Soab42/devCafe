...
export default function LoginModal({ show }) {
  return (
    show && (
      <div className="absolute h-[98vh] w-[14rem] right-0 top-8 flex items-center p-4 bg-blue-500/10 rounded-md backdrop-blur-sm z-50 font-sans text-xs flex-col fade">
