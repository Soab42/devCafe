...
const Terminal = () => {
  return (
    <div className="bg-gray-900 text-white p-8 absolute right-0">
      <div className="bg-black p-4 rounded-lg shadow-lg">
        <pre className="text-green-300 flex flex-col text-[8pz]">
          <span>
            $ welcome to the terminal $ ls -l total 16 -rw-r--r-- 1 user user 88
          </span>
          Nov 4 00:00 index.html drwxr-xr-x 2 user user 96 Nov 4 00:00 css
          drwxr-xr-x 2 user user 80 Nov 4 00:00 js drwxr-xr-x 2 user user 112
          Nov 4 00:00 images $ cd .. $ pwd /home/user $ exit
        </pre>
      </div>
    </div>
  );
