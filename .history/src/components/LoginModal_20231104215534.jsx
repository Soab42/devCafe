...
const Terminal = () => {
  return (
    <div className="bg-gray-900 p-0.5 absolute right-0 z-30">
      <div className="bg-black px-2 gap-2 rounded-md shadow-lg">
        <pre
          className="text-sky-600 flex flex-col h-36 w-36
         text-[8px] gap-0"
        >
          ...
          <input
            ...
            className="bg-inherit h-5 pl-2  outline-none terminal"
          />
        </pre>
      </div>
    </div>
