      ...
      <div className="flex justify-between items-center md:w-[60%] w-[90%]">
        ...
        {user?.user ? (
          ...
          <div className="relative">
            <button onClick={handleLogin} className=" bg-black w-20 flex">
              <span className="scale-150 animate-pulse hover:animate-none duration-300 text-sky-500 flex-center ">
                <DiTerminalBadge />
              </span>
              <span className="text-xs">yarn dev</span>
            </button>
