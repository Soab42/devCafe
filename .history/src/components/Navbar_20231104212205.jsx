...
import { SiCoffeescript, SiPackagist } from "react-icons/si";
      ...
      <div className="flex justify-between items-center md:w-[60%] w-[90%]">
        ...
        {user?.user ? (
          ...
          <div className="relative">
            <button onClick={handleLogin} className=" bg-black w-24 h-6 flex">
              <span className="scale-110 animate-pulse hover:animate-none duration-300 text-sky-500 flex-center ">
                <DiTerminalBadge />
              </span>
              {/* <span className="text-[10px] font-mono">$ yarn dev</span> */}
              <span className="text-[10px] font-mono animate-left-right absolute flex-center">
                <SiPackagist /> Linking Dependencies
              </span>
            </button>
