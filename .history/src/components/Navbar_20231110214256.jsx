      ...
      <div className="flex justify-between items-center md:w-[60%] w-[90%]">
        ...
        {user?.user ? (
          ...
          <div className="relative">
            <button className=" bg-black w-32 h-6 flex">
              <span
                className="scale-110 animate-pulse hover:animate-none duration-300 text-sky-500 flex-center "
                onClick={handleLogin}
              >
                <DiTerminalBadge />
              </span>
              <span className="text-[8px] font-mono">
                {!mood ? (
                  ...
                  <div
                    className="flex-center text-[8px] gap-0.5"
                    onClick={handleLogin}
                  >
