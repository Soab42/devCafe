...
export const postData = [
  {
    ...
    post: `Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus id vitae harum molestiae eos sunt voluptatem laudantium. Voluptatem, doloremque molestiae, #code# <html>alias delectus eligendi fugiat aspernatur</html> #endcode vel reiciendis ipsum molestias, architecto id? Ea reiciendis, suscipit doloremque nihil quos natus dolores dolorum a, deserunt, nemo harum reprehenderit unde? Asperiores autem eligendi eaque. #code#function(Lorem){const test=ipsum dolor sit amet consectetur adipisicing elit. } #endcode Quod perferendis eveniet vel voluptatibus odio omnis sit obcaecati veritatis sint aspernatur minus asperiores quae at ullam excepturi, illum natus consequatur blanditiis.`,
